package com.example.galuhwisnupambayun.galuh_1202150076_studycase5.UserInterface;
...
import com.example.galuhwisnupambayun.galuh_1202150076_studycase5.DatabaseHandler;
import com.example.galuhwisnupambayun.galuh_1202150076_studycase5.R;
import com.example.galuhwisnupambayun.galuh_1202150076_studycase5.RecyclerAdapter;
import com.example.galuhwisnupambayun.galuh_1202150076_studycase5.SwipeHelper;

import java.util.LinkedList;

public class MainActivity extends AppCompatActivity {

    private LinkedList<com.example.galuhwisnupambayun.galuh_1202150076_studycase5.Bentuk.Activity> mActivity = new LinkedList<>();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new com.example.galuhwisnupambayun.galuh_1202150076_studycase5.Bentuk.Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
